!function(e, t) {
    ...
    var h = function(n) {
        ...
        var e, h, _, o, s, p, d, g, w, l, u, x, E, a, T, m, c, v, y, C = "sizzle" + +new Date, b = n.document, S = 0, i = 0, k = le(), D = le(), A = le(), N = le(), j = function(e, t) {
            return e === t && (u = !0),
            0
        }, O = {}.hasOwnProperty, t = [], L = t.pop, I = t.push, q = t.push, P = t.slice, H = function(e, t) {
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, R = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "[\\x20\\t\\r\\n\\f]", F = "(?:\\\\[\\da-fA-F]{1,6}" + M + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", B = "\\[" + M + "*(" + F + ")(?:" + M + "*([*^$|!~]?=)" + M + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + F + "))|)" + M + "*\\]", Q = ":(" + F + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + B + ")*)|.*)\\)|)", W = new RegExp(M + "+","g"), U = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$","g"), $ = new RegExp("^" + M + "*," + M + "*"), z = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"), V = new RegExp(M + "|>"), X = new RegExp(Q), Y = new RegExp("^" + F + "$"), K = {
            ID: new RegExp("^#(" + F + ")"),
            CLASS: new RegExp("^\\.(" + F + ")"),
            TAG: new RegExp("^(" + F + "|[*])"),
            ATTR: new RegExp("^" + B),
        ...
        }, G = /HTML$/i, J = /^(?:input|select|textarea|button)$/i, Z = /^h\d$/i, ee = /^[^{]+\{\s*\[native \w/, te = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ne = /[+~]/, ie = new RegExp("\\\\[\\da-fA-F]{1,6}" + M + "?|\\\\([^\\r\\n\\f])","g"), re = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, oe = function(e, t) {
        ...
        function ae(e, t, n, i) {
            ...
            T)) {
                ...
                if (h.qsa && !N[e + " "] && (!m || !m.test(e)) && (1 !== d || "object" !== t.nodeName.toLowerCase())) {
                    if (c = e,
                    f = t,
                    1 === d && (V.test(e) || z.test(e))) {
                        for ((f = ne.test(e) && ge(t.parentNode) || t) === t && h.scope || ((a = t.getAttribute("id")) ? a = a.replace(re, oe) : t.setAttribute("id", a = C)),
                        o = (u = p(e)).length; o--; )
        ...
        x = ae.setDocument = function(e) {
            ...
            return i != E && 9 === i.nodeType && i.documentElement && (a = (E = i).documentElement,
            T = !s(E),
            ...
            h.scope = ce(function(e) {
                return a.appendChild(e).appendChild(E.createElement("div")),
            ...
            c = [],
            m = [],
            (h.qsa = ee.test(E.querySelectorAll)) && (ce(function(e) {
                var t;
            ...
            : function(e, t) {
                ...
                if (!r || !o)
                    return e == E ? -1 : t == E ? 1 : r ? -1 : o ? 1 : l ? H(l, e) - H(l, t) : 0;
                if (r === o)
                    return de(e, t);
        ...
        ae.matchesSelector = function(e, t) {
            if (x(e),
            h.matchesSelector && T && !N[t + " "] && (!c || !c.test(t)) && (!m || !m.test(t)))
                try {
                    var n = v.call(e, t);
        ...
        (_ = ae.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return K.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && X.test(n) && (t = p(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
                            ...
                            ue(function(e, t, n, i) {
                                var r, o, s, a = [], l = [], u = t.length, c = e || function(e, t, n) {
                                    for (var i = 0, r = t.length; i < r; i++)
                                        ae(e, t[i], n);
                                    return n
                                }(p || "*", n.nodeType ? [n] : n, []), f = !h || !e && p ? c : _e(c, a, h, n, i), d = g ? v || (e ? h : u || m) ? [] : t : f;
                                if (g && g(f, d, n, i),
                                m)
                                    for (r = _e(d, l),
                                    m(r, [], n, i),
                                ...
                                if (e) {
                                    ...
                                    d = _e(d === t ? d.splice(u, d.length) : d),
                                    v ? v(null, t, d, i) : q.apply(t, d)
                            })
        ...
        p = ae.tokenize = function(e, t) {
            ...
            a = [],
            l = _.preFilter; s; ) {
                for (o in n && !(i = $.exec(s)) || (i && (s = s.slice(i[0].length) || s),
                a.push(r = [])),
                n = !1,
        ...
        g = ae.select = function(e, t, n, i) {
            ...
            return (u || d(e, c))(i, t, !T, n, !t || ne.test(e) && ge(t.parentNode) || t),
            n
        }
        ,
    ...
    C.each({
        ...
        contents: function(e) {
            return null != e.contentDocument && i(e.contentDocument) ? e.contentDocument : (k(e, "template") && (e = e.content || e),
        ...
        function r() {
            ...
            t = o = !0; l.length; u = -1)
                for (e = l.shift(); ++u < a.length; )
                    !1 === a[u].apply(e[0], e[1]) && i.stopOnFalse && (u = a.length,
                    e = !1);
            i.memory || (e = !1),
            o = !1,
            s && (a = e ? [] : "")
                        ...
                        return function() {
                            function e() {
                                ...
                                if (!(r < l)) {
                                    ...
                                    b(t) ? a ? t.call(e, u(l, o, P, a), u(l, o, H, a)) : (l++,
    ...
    C.ready.then = F.then,
    "complete" === T.readyState || "loading" !== T.readyState && !T.documentElement.doScroll ? E.setTimeout(C.ready) : (T.addEventListener("DOMContentLoaded", B),
    ...
    C.fn.extend({
        data: function(n, e) {
            ...
            1 === o.nodeType && !Y.get(o, "hasDataAttrs"))) {
                for (t = s.length; t--; )
                    s[t] && 0 === (i = s[t].name).indexOf("data-") && (i = z(i.slice(5)),
                    Z(o, i, r[i]));
    ...
    C.fn.extend({
        ...
        promise: function(e, t) {
            ...
            e = void 0),
            e = e || "fx"; a--; )
                (i = Y.get(s[a], e + "queueHooks")) && i.empty && (r++,
                i.empty.add(n));
            return n(),
            o.promise(t)
        }
    ...
    function ae(e, t, n, i) {
        ...
        , l = a(), u = n && n[3] || (C.cssNumber[t] ? "" : "px"), c = e.nodeType && (C.cssNumber[t] || "px" !== u && +l) && te.exec(C.css(e, t));
        if (c && c[3] !== u) {
            for (l /= 2,
            u = u || c[3],
            c = +l || 1; s--; )
    ...
    function ue(e, t) {
        for (var n, i, r, o, s, a, l = [], u = 0, c = e.length; u < c; u++)
            ...
            l[u] || (i.style.display = "")),
            "" === i.style.display && se(i) && (l[u] = (a = o = r = void 0,
            o = i.ownerDocument,
            s = i.nodeName,
    ...
    var ce, fe = /^(?:checkbox|radio)$/i, de = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, he = /^$|^module$|\/(?:java|ecma)script/i, pe = T.createDocumentFragment().appendChild(T.createElement("div"));
    ...
    C.event = {
        ...
        dispatch: function(e) {
            var t, n, i, r, o, s, a = new Array(arguments.length), l = C.event.fix(e), u = (Y.get(this, "events") || Object.create(null))[l.type] || [], c = C.event.special[l.type] || {};
            for (a[0] = l,
    ...
    function qe(n, i, r, o) {
        i = m(i);
        var e, t, s, a, l, u, c = 0, f = n.length, d = f - 1, h = i[0], p = b(h);
        ...
        t || o)) {
            ...
            if (a)
                ...
                c = 0; c < a; c++)
                    l = s[c],
                    he.test(l.type || "") && !Y.access(l, "globalEval") && C.contains(u, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
    ...
    C.extend({
        ...
        clone: function(e, t, n) {
            var i, r, o, s, a, l, u, c = e.cloneNode(!0), f = re(e);
            if (!(y.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e)))
                for (s = me(c),
                i = 0,
                r = (o = me(e)).length; i < r; i++)
                    a = o[i],
                    "input" === (u = (l = s[i]).nodeName.toLowerCase()) && fe.test(a.type) ? l.checked = a.checked : "input" !== u && "textarea" !== u || (l.defaultValue = a.defaultValue);
            if (t)
                if (n)
                    for (o = o || me(e),
                    s = s || me(c),
    ...
    var Re, Me, Fe, Be, Qe, We, Ue, $e, ze = new RegExp("^(" + ee + ")(?!px)[a-z%]+$","i"), Ve = function(e) {
    ...
    function Ye(e, t, n) {
        ...
        return (n = n || Ve(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || re(e) || (s = C.style(e, t)),
        !y.pixelBoxStyles() && ze.test(s) && Xe.test(t) && (i = a.width,
        r = a.minWidth,
        o = a.maxWidth,
    ...
    function Ge() {
        var e;
        $e && (Ue.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0",
    ...
    ($e = T.createElement("div")).style && ($e.style.backgroundClip = "content-box",
    ...
    function ut(e, t, n) {
        ...
        return (!y.boxSizingReliable() && r || !y.reliableTrDimensions() && k(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === C.css(e, "display", !1, i)) && e.getClientRects().length && (r = "border-box" === C.css(e, "boxSizing", !1, i),
        (o = a in e) && (s = e[a])),
    ...
    C.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = z(t), l = rt.test(t), u = e.style;
                if (l || (t = nt(a)),
    ...
    C.each(["height", "width"], function(e, l) {
        C.cssHooks[l] = {
            get: function(e, t, n) {
                if (t)
                    return !it.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ut(e, l, n) : He(e, ot, function() {
                        return ut(e, l, n)
                    })
            },
            set: function(e, t, n) {
                var i, r = Ve(e), o = !y.scrollboxSize() && "absolute" === r.position, s = (o || n) && "border-box" === C.css(e, "boxSizing", !1, r), a = n ? lt(e, l, n, s, r) : 0;
    ...
    C.fx.step = {};
    var ft, dt, ht, pt, gt = /^(?:toggle|show|hide)$/, mt = /queueHooks$/;
    function vt() {
        dt && (!1 === T.hidden && E.requestAnimationFrame ? E.requestAnimationFrame(vt) : E.setTimeout(vt, C.fx.interval),
        C.fx.tick())
    }
    function yt() {
    ...
    function wt(o, e, t) {
        var n, s, i = 0, r = wt.prefilters.length, a = C.Deferred().always(function() {
            ...
            if (s)
                return !1;
            for (var e = ft || yt(), t = Math.max(0, u.startTime + u.duration - e), n = 1 - (t / u.duration || 0), i = 0, r = u.tweens.length; i < r; i++)
                u.tweens[i].run(n);
        ...
        for (function(e, t) {
            ...
            if (n = wt.prefilters[i].call(u, o, c, u.opts))
                return b(n.stop) && (C._queueHooks(u.elem, u.opts.queue).stop = n.stop.bind(n)),
                n;
        return C.map(c, _t, u),
    ...
    C.Animation = C.extend(wt, {
        ...
        tweener: function(e, t) {
            ...
            ["*"]) : e.match(q)).length; i < r; i++)
                n = e[i],
                wt.tweeners[n] = wt.tweeners[n] || [],
                wt.tweeners[n].unshift(t)
        },
        prefilters: [function(e, t, n) {
            var i, r, o, s, a, l, u, c, f = "width"in t || "height"in t, d = this, h = {}, p = e.style, g = e.nodeType && se(e), m = Y.get(e, "fxshow");
    ...
    C.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute ? C.prop(e, t, n) : (1 === o && C.isXMLDoc(e) || (r = C.attrHooks[t.toLowerCase()] || (C.expr.match.bool.test(t) ? xt : void 0)),
        ...
        toggleClass: function(r, t) {
            ...
            return "boolean" == typeof t && s ? t ? this.addClass(r) : this.removeClass(r) : b(r) ? this.each(function(e) {
                ...
                if (s)
                    ...
                    void 0 !== r && "boolean" != o || ((e = kt(this)) && Y.set(this, "__className__", e),
    ...
    C.extend(C.event, {
        trigger: function(e, t, n, i) {
            var r, o, s, a, l, u, c, f = [n || T], d = v.call(e, "type") ? e.type : e, h = v.call(e, "namespace") ? e.namespace.split(".") : [], p = c = o = n = n || T;
            if (3 !== n.nodeType && 8 !== n.nodeType && !jt.test(d + C.event.triggered) && (-1 < d.indexOf(".") && (d = (h = d.split(".")).shift(),
            h.sort()),
            a = d.indexOf(":") < 0 && "on" + d,
            ...
            i || !u.trigger || !1 !== u.trigger.apply(n, t))) {
                if (!i && !u.noBubble && !g(n)) {
                    ...
                    jt.test(s + d) || (p = p.parentNode); p; p = p.parentNode)
                        f.push(p),
                        o = p;
                ...
                return e.type = d,
                i || e.isDefaultPrevented() || u._default && !1 !== u._default.apply(f.pop(), t) || !V(n) || a && b(n[d]) && !g(n) && ((o = n[a]) && (n[a] = null),
                C.event.triggered = d,
    ...
    y.focusin || C.each({
        ...
        C.event.special[i] = {
            ...
            teardown: function() {
                var e = this.ownerDocument || this.document || this
                  , t = Y.access(e, i) - 1;
                t ? Y.access(e, i, t) : (e.removeEventListener(n, r, !0),
                Y.remove(e, i))
            }
        }
    });
    ...
    C.extend({
        ...
        ajax: function(e, t) {
            ...
            e = void 0),
            t = t || {};
            var c, f, d, n, h, i, p, g, r, o, m = C.ajaxSetup({}, t), v = m.context || m, y = m.context && (v.nodeType || v.jquery) ? C(v) : C.event, b = C.Deferred(), _ = C.Callbacks("once memory"), w = m.statusCode || {}, s = {}, a = {}, l = "canceled", x = {
                readyState: 0,
            ...
            f = m.url.replace(Ft, ""),
            m.hasContent ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(Mt, "+")) : (o = m.url.slice(f.length),
            m.data && (m.processData || "string" == typeof m.data) && (f += (It.test(f) ? "&" : "?") + m.data,
            delete m.data),
            !1 === m.cache && (f = f.replace(Bt, "$1"),
            o = (It.test(f) ? "&" : "?") + "_=" + Lt.guid++ + o),
            m.url = f + o),
            m.ifModified && (C.lastModified[f] && x.setRequestHeader("If-Modified-Since", C.lastModified[f]),
            ...
            function u(e, t, n, i) {
                ...
                r ? (m.ifModified && ((l = x.getResponseHeader("Last-Modified")) && (C.lastModified[f] = l),
    ...
    C.parseHTML = function(e, t, n) {
        ...
        o = !n && [],
        (r = D.exec(e)) ? [t.createElement(r[1])] : (r = be([e], t, o),
...
function(t) {
    ...
    i.console && i.console.log && (a && e("3.0.0") || i.console.log("JQMIGRATE: jQuery 3.0.0+ REQUIRED"),
    ...
    function l(e) {
        var t = i.console;
        a.migrateDeduplicateWarnings && n[e] || (n[e] = !0,
        a.migrateWarnings.push(e),
        t && t.warn && !a.migrateMute && (t.warn("JQMIGRATE: " + e),
    ...
    var o, s, u = {}, c = a.fn.init, f = a.find, d = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/, h = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/g, p = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;
    ...
    e("3.1.1") && r(a, "trim", function(e) {
        return null == e ? "" : (e + "").replace(p, "")
    }, "jQuery.trim is deprecated; use String.prototype.trim"),
    e("3.2.0") && r(a, "nodeName", function(e, t) {
        return e.nodeName && e.nodeName.toLowerCase() === t.toLowerCase()
    }, "jQuery.nodeName is deprecated"),
    e("3.3.0") && (r(a, "isNumeric", function(e) {
        var t = typeof e;
        return ("number" == t || "string" == t) && !isNaN(e - parseFloat(e))
    ...
    r(a, "isFunction", function(e) {
        return "function" == typeof e
    }, "jQuery.isFunction() is deprecated"),
    r(a, "isWindow", function(e) {
        return null != e && e === e.window
    ...
    a.ajax = function() {
        ...
        return e.promise && (r(e, "success", e.done, "jQXHR.success is deprecated and removed"),
        r(e, "error", e.fail, "jQXHR.error is deprecated and removed"),
        r(e, "complete", e.always, "jQXHR.complete is deprecated and removed")),
        e
    }
    );
    ...
    var b, _ = !(a.fn.toggleClass = function(t) {
        return void 0 !== t && "boolean" != typeof t ? m.apply(this, arguments) : (l("jQuery.fn.toggleClass( boolean ) is deprecated"),
        this.each(function() {
            var e = this.getAttribute && this.getAttribute("class") || "";
            e && a.data(this, "__className__", e),
            this.setAttribute && this.setAttribute("class", !e && !1 !== t && a.data(this, "__className__") || "")
        }))
    }
    ...
    a.swap = function(e, t, n, i) {
        var r, o, s = {};
        for (o in _ || l("jQuery.swap() is undocumented and deprecated"),
        t)
            s[o] = e.style[o],
            e.style[o] = t[o];
    ...
    a.fn.css = function(e, t) {
        ...
        "number" == typeof t && (i = n = y(e),
        w.test(i) && x.test(i[0].toUpperCase() + i.slice(1)) || a.cssNumber[n] || l('Number-typed values are deprecated for jQuery.fn.css( "' + e + '", value )')),
    ...
    a.data = function(e, t, n) {
        ...
        if (t && "object" == typeof t && 2 === arguments.length) {
            for (o in i = a.hasData(e) && k.call(this, e),
            r = {},
            t)
                o !== y(o) ? (l("jQuery.data() always sets/gets camelCased names: " + o),
                i[o] = t[o]) : r[o] = t[o];
            return k.call(this, e, r),
            t
        }
        return t && "string" == typeof t && t !== y(t) && (i = a.hasData(e) && k.call(this, e)) && t in i ? (l("jQuery.data() always sets/gets camelCased names: " + t),
        2 < arguments.length && (i[t] = n),
        i[t]) : k.apply(this, arguments)
    }
    ,
    a.fx && (C = a.Tween.prototype.run,
    S = function(e) {
        return e
    }
    ,
    a.Tween.prototype.run = function() {
        1 < a.easing[this.easing].length && (l("'jQuery.easing." + this.easing.toString() + "' should use only one argument"),
    ...
    i.requestAnimationFrame && Object.defineProperty(a.fx, "interval", {
        configurable: !0,
        enumerable: !0,
        get: function() {
            return i.document.hidden || l(T),
            E
        },
        set: function(e) {
            l(T),
    ...
    a.event.fix = function(e) {
        var t, n = e.type, i = this.fixHooks[n], r = a.event.props;
        if (r.length)
            for (l("jQuery.event.props are deprecated and removed: " + r.join()); r.length; )
        ...
        i && i.filter ? i.filter(t, e) : t
    }
    ,
    a.event.add = function(e, t) {
        return e === i && "load" === t && "complete" === i.document.readyState && l("jQuery(window).on('load'...) called after load event occurred"),
    ...
    a.each(["load", "unload", "error"], function(e, t) {
        a.fn[t] = function() {
            ...
            return "load" === t && "string" == typeof e[0] ? D.apply(this, e) : (l("jQuery.fn." + t + "() is deprecated"),
            e.splice(0, 0, t),
    ...
    a.each("blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu".split(" "), function(e, n) {
        a.fn[n] = function(e, t) {
            return l("jQuery.fn." + n + "() event shorthand is deprecated"),
    ...
    a.fn.offset = function() {
        var e = this[0];
        return !e || e.nodeType && e.getBoundingClientRect ? P.apply(this, arguments) : (l("jQuery.fn.offset() requires a valid DOM element"),
    ...
    ,
    a.Deferred && (H = a.Deferred,
    R = [["resolve", "done", a.Callbacks("once memory"), a.Callbacks("once memory"), "resolved"], ["reject", "fail", a.Callbacks("once memory"), a.Callbacks("once memory"), "rejected"], ["notify", "progress", a.Callbacks("memory"), a.Callbacks("memory")]],
...
function(e, t) {
    ...
    p(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', c._handleDismiss(new c)),
    ...
    var f = "button"
      ...
      , b = function() {
        ...
        return e.toggle = function() {
            ...
            !r || (e = this._element.querySelector(y)) && ("radio" === e.type && (e.checked && this._element.classList.contains(m) ? n = !1 : (t = r.querySelector(".active")) && p(t).removeClass(m)),
            n && ("checkbox" !== e.type && "radio" !== e.type || (e.checked = !this._element.classList.contains(m)),
            p(e).trigger("change")),
            e.focus(),
            i = !1),
            this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (i && this._element.setAttribute("aria-pressed", !this._element.classList.contains(m)),
    ...
    var _ = "carousel"
      ...
      , O = function() {
        ...
        e._addTouchEventListeners = function() {
            ...
            ,
            t = function(e) {
                n._pointerEvent && j[e.originalEvent.pointerType.toUpperCase()] && (n.touchDeltaX = e.originalEvent.clientX - n.touchStartX),
                n._handleSwipe(),
        ...
        e._setActiveIndicatorElement = function(e) {
            ...
            p(t).removeClass(A),
            (n = this._indicatorsElement.children[this._getItemIndex(e)]) && p(n).addClass(A))
        }
        ,
        e._slide = function(e, t) {
            var n, i, r, o, s, a = this, l = this._element.querySelector(N), u = this._getItemIndex(l), c = t || l && this._getItemByDirection(e, l), f = this._getItemIndex(c), d = Boolean(this._interval), h = e === S ? (n = "carousel-item-left",
            i = "carousel-item-next",
            "left") : (n = "carousel-item-right",
            i = "carousel-item-prev",
            "right");
            c && p(c).hasClass(A) ? this._isSliding = !1 : this._triggerSlideEvent(c, h).isDefaultPrevented() || l && c && (this._isSliding = !0,
            d && this.pause(),
            ...
            p(this._element).hasClass("slide") ? (p(c).addClass(i),
            g.reflow(c),
            p(l).addClass(n),
            p(c).addClass(n),
            (o = parseInt(c.getAttribute("data-interval"), 10)) ? (this._config.defaultInterval = this._config.defaultInterval || this._config.interval,
            ...
            p(l).one(g.TRANSITION_END, function() {
                p(c).removeClass(n + " " + i).addClass(A),
                p(l).removeClass(A + " " + i + " " + n),
                a._isSliding = !1,
                setTimeout(function() {
                    return p(a._element).trigger(r)
                }, 0)
            }).emulateTransitionEnd(s)) : (p(l).removeClass(A),
            p(c).addClass(A),
            this._isSliding = !1,
        ...
        o._dataApiClickHandler = function(e) {
            ...
            !r || (t = p(r)[0]) && p(t).hasClass("carousel") && (n = l(l({}, p(t).data()), p(this).data()),
    ...
    p(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", O._dataApiClickHandler),
    ...
    var L = "collapse"
      ...
      , W = function() {
        ...
        e.show = function() {
            ...
            e && (t = p(e).not(this._selector).data(I)) && t._isTransitioning || (n = p.Event("show.bs.collapse"),
            p(this._element).trigger(n),
            n.isDefaultPrevented() || (e && (a._jQueryInterface.call(p(e).not(this._selector), "hide"),
            t || p(e).data(I, null)),
            i = this._getDimension(),
            p(this._element).removeClass(M).addClass(F),
            this._element.style[i] = 0,
            this._triggerArray.length && p(this._triggerArray).removeClass(B).attr("aria-expanded", !0),
            ...
            p(this._element).one(g.TRANSITION_END, function() {
                p(s._element).removeClass(F).addClass(M + " " + R),
                s._element.style[i] = "",
        ...
        e.hide = function() {
            ...
            if (!this._isTransitioning && p(this._element).hasClass(R)) {
                ...
                !t.isDefaultPrevented()) {
                    ...
                    p(this._element).addClass(F).removeClass(M + " " + R);
                    ...
                    p(this._element).one(g.TRANSITION_END, function() {
                        ...
                        p(e._element).removeClass(F).addClass(M).trigger("hidden.bs.collapse")
        ...
        ,
        e._getConfig = function(e) {
            return (e = l(l({}, P), e)).toggle = Boolean(e.toggle),
    ...
    function te(e) {
        ...
        for (var t = ee(10) ? document.body : null, n = e.offsetParent || null; n === t && e.nextElementSibling; )
    ...
    function ie(e, t) {
        ...
        if (e !== l && t !== l || i.contains(r))
            return "BODY" === (a = (s = l).nodeName) || "HTML" !== a && te(s.firstElementChild) !== s ? te(l) : l;
        var u = ne(e);
    ...
    function pe(e) {
        var t, n, i = {};
        try {
            ee(10) ? (i = e.getBoundingClientRect(),
            t = re(e, "top"),
            n = re(e, "left"),
            i.top += t,
            i.left += n,
        ...
        }, s = "HTML" === e.nodeName ? ae(e.ownerDocument) : {}, a = s.width || e.clientWidth || o.width, l = s.height || e.clientHeight || o.height, u = e.offsetWidth - a, c = e.offsetHeight - l;
        return (u || c) && (u -= oe(r = X(e), "x"),
        c -= oe(r, "y"),
        o.width -= u,
        o.height -= c),
        he(o)
    ...
    function ge(e, t, n) {
        ...
        p.marginLeft = 0,
        !r && o && (d = parseFloat(u.marginTop, 10),
    ...
    function ve(e, t, n, i, r) {
        var o, s, a, l, u, c = 4 < arguments.length && void 0 !== r && r, f = {
            top: 0,
            left: 0
        }, d = c ? me(e) : ie(e, G(t));
        ...
        "scrollParent" === i ? "BODY" === (o = K(Y(t))).nodeName && (o = e.ownerDocument.documentElement) : o = "window" === i ? e.ownerDocument.documentElement : i,
        s = ge(o, d, c),
        "HTML" !== o.nodeName || function e(t) {
            ...
            var i = Y(t);
            return !!i && e(i)
        }(d) ? f = s : (l = (a = ae(e.ownerDocument)).height,
        u = a.width,
    ...
    function Te(e, n, t) {
        return (void 0 === t ? e : e.slice(0, function(e, t, n) {
            ...
            e.enabled && V(t) && (n.offsets.popper = he(n.offsets.popper),
    ...
    function je(n, i) {
        Object.keys(i).forEach(function(e) {
            var t = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(e) && Ne(i[e]) && (t = "px"),
            n.style[e] = i[e] + t
        })
    }
    function Oe(e, t) {
    ...
    var Qe = {
        ...
        modifiers: {
            shift: {
                ...
                enabled: !0,
                fn: function(e) {
                    var t, n, i, r, o, s, a, l = e.placement, u = l.split("-")[0], c = l.split("-")[1];
                    return c && (n = (t = e.offsets).reference,
                    i = t.popper,
            ...
            arrow: {
                ...
                fn: function(e, t) {
                    ...
                    e.offsets.arrow = (fe(n = {}, f, Math.round(b)),
                    fe(n, d, ""),
                    n),
                    e
                },
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(m, v) {
                    if (Ce(m.instance.modifiers, "inner"))
                        return m;
                    ...
                    return x.forEach(function(e, t) {
                        ...
                        b = m.placement.split("-")[0],
                        _ = we(b);
                        var n, i = m.offsets.popper, r = m.offsets.reference, o = Math.floor, s = "left" === b && o(i.right) > o(r.left) || "right" === b && o(i.left) < o(r.right) || "top" === b && o(i.bottom) > o(r.top) || "bottom" === b && o(i.top) < o(r.bottom), a = o(i.left) < o(y.left), l = o(i.right) > o(y.right), u = o(i.top) < o(y.top), c = o(i.bottom) > o(y.bottom), f = "left" === b && a || "right" === b && l || "top" === b && u || "bottom" === b && c, d = -1 !== ["top", "bottom"].indexOf(b), h = !!v.flipVariations && (d && "start" === w && a || d && "end" === w && l || !d && "start" === w && u || !d && "end" === w && c), p = !!v.flipVariationsByContent && (d && "start" === w && l || d && "end" === w && a || !d && "start" === w && c || !d && "end" === w && u), g = h || p;
                        (s || f || g) && (m.flipped = !0,
                        (s || f) && (b = x[t + 1]),
                        g && (w = "end" === (n = w) ? "start" : "start" === n ? "end" : n),
                        m.placement = b + (w ? "-" + w : ""),
                        m.offsets.popper = de({}, m.offsets.popper, xe(m.instance.popper, m.offsets.reference, m.placement)),
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var s, a, l = void 0 !== o ? o : t.gpuAcceleration, u = te(e.instance.popper), c = pe(u), f = {
                        position: r.position
                    }, d = Oe(e, window.devicePixelRatio < 2 || !Le), h = "bottom" === n ? "top" : "bottom", p = "right" === i ? "left" : "right", g = Se("transform"), m = void 0, v = void 0, v = "bottom" == h ? "HTML" === u.nodeName ? -u.clientHeight + d.bottom : -c.height + d.bottom : d.top, m = "right" == p ? "HTML" === u.nodeName ? -u.clientWidth + d.right : -c.width + d.right : d.left;
                    l && g ? (f[g] = "translate3d(" + m + "px, " + v + "px, 0)",
                    f[h] = 0,
                    f[p] = 0,
                    f.willChange = "transform") : (s = "bottom" == h ? -1 : 1,
                    a = "right" == p ? -1 : 1,
                    f[h] = v * s,
                    f[p] = m * a,
                    f.willChange = h + ", " + p);
                    ...
                    return e.attributes = de({}, y, e.attributes),
            ...
            applyStyle: {
                ...
                fn: function(e) {
                    var t, n;
                    return je(e.instance.popper, e.styles),
                    t = e.instance.popper,
                    n = e.attributes,
                    Object.keys(n).forEach(function(e) {
                        !1 !== n[e] ? t.setAttribute(e, n[e]) : t.removeAttribute(e)
                    }),
                    e.arrowElement && Object.keys(e.arrowStyles).length && je(e.arrowElement, e.arrowStyles),
                    e
                },
      ...
      , We = (ue(Ue, [{
        ...
        value: function() {
            return function() {
                ...
                e.offsets.popper = xe(this.popper, e.offsets.reference, e.placement),
        ...
        value: function() {
            return function() {
                ...
                Ce(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"),
    ...
    function Ue(e, t) {
        ...
        Object.keys(de({}, Ue.Defaults.modifiers, i.modifiers)).forEach(function(e) {
    ...
    var $e = "dropdown"
      ...
      , lt = function() {
        ...
        return e.toggle = function() {
            var e;
            this._element.disabled || p(this._element).hasClass(tt) || (e = p(this._menu).hasClass(nt),
            u._clearMenus(),
            e || this.show(!0))
        }
        ,
        e.show = function(e) {
            if (void 0 === e && (e = !1),
            !(this._element.disabled || p(this._element).hasClass(tt) || p(this._menu).hasClass(nt))) {
                var t = {
        ...
        e._getMenuElement = function() {
            var e;
            return this._menu || (e = u._getParentFromElement(this._element)) && (this._menu = e.querySelector(ot)),
            this._menu
        }
        ,
        e._getPlacement = function() {
            var e = p(this._element.parentNode)
              , t = "bottom-start";
            return e.hasClass("dropup") ? t = p(this._menu).hasClass(it) ? "top-end" : "top-start" : e.hasClass("dropright") ? t = "right-start" : e.hasClass("dropleft") ? t = "left-start" : p(this._menu).hasClass(it) && (t = "bottom-end"),
            t
        }
        ,
        ...
        u._clearMenus = function(e) {
            if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
                for (var t = [].slice.call(document.querySelectorAll(rt)), n = 0, i = t.length; n < i; n++) {
                    var r, o, s = u._getParentFromElement(t[n]), a = p(t[n]).data(ze), l = {
                        relatedTarget: t[n]
                    };
                    e && "click" === e.type && (l.clickEvent = e),
                    a && (r = a._menu,
                    p(s).hasClass(nt) && (e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && p.contains(s, e.target) || (o = p.Event(Ge, l),
                    p(s).trigger(o),
    ...
    var ut = "modal"
      ...
      , Dt = function() {
        ...
        e.show = function(e) {
            var t, n = this;
            this._isShown || this._isTransitioning || (p(this._element).hasClass(Et) && (this._isTransitioning = !0),
            t = p.Event(mt, {
                relatedTarget: e
            }),
        ...
        e.hide = function(e) {
            ...
            (n = p(this._element).hasClass(Et)) && (this._isTransitioning = !0),
            this._setEscapeEvent(),
            this._setResizeEvent(),
            p(document).off(vt),
        ...
        e._showBackdrop = function(e) {
            var t, n, i = this, r = p(this._element).hasClass(Et) ? Et : "";
            if (this._isShown && this._config.backdrop) {
                ...
                !this._isShown && this._backdrop ? (p(this._backdrop).removeClass(Tt),
                t = function() {
                    i._removeBackdrop(),
                    e && e()
                }
                ,
                p(this._element).hasClass(Et) ? (n = g.getTransitionDurationFromElement(this._backdrop),
        ...
        e._setScrollbar = function() {
            var e, t, n, i, r = this;
            this._isBodyOverflowing && (e = [].slice.call(document.querySelectorAll(St)),
        ...
        for (var n = (new window.DOMParser).parseFromString(e, "text/html"), s = Object.keys(o), a = [].slice.call(n.body.querySelectorAll("*")), i = function(e) {
            ...
            i.forEach(function(e) {
                !function(e, t) {
                    ...
                    if (-1 !== t.indexOf(n))
                        return -1 === At.indexOf(n) || Boolean(e.nodeValue.match(jt) || e.nodeValue.match(Ot));
      ...
      , Kt = function() {
        ...
        e.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                p(this.tip).hasClass(zt) ? (u = g.getTransitionDurationFromElement(this.tip),
                p(this.tip).one(g.TRANSITION_END, c).emulateTransitionEnd(u)) : c()
            }
        }
        ,
        e.hide = function(e) {
            function t() {
                i._hoverState !== Ut && r.parentNode && r.parentNode.removeChild(r),
                i._cleanTipClass(),
            ...
            o.isDefaultPrevented() || (p(r).removeClass(Vt),
            ...
            p(this.tip).hasClass(zt) ? (n = g.getTransitionDurationFromElement(r),
        ...
        e.setElementContent = function(e, t) {
            "object" != typeof t || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = Lt(t, this.config.whiteList, this.config.sanitizeFn)),
        ...
        e._enter = function(e, t) {
            ...
            p(t.getTipElement()).hasClass(Vt) || t._hoverState === Ut ? t._hoverState = Ut : (clearTimeout(t._timeout),
            t._hoverState = Ut,
        ...
        e._fixTransition = function() {
            ...
            null === e.getAttribute("x-placement") && (p(e).removeClass(zt),
    ...
    var ln = "scrollspy"
      ...
      , bn = function() {
        function n(e, t) {
            ...
            this._config = this._getConfig(t),
            this._selector = this._config.target + " " + mn + "," + this._config.target + " " + vn + "," + this._config.target + " .dropdown-item",
            this._offsets = [],
            this._targets = [],
        ...
        e._getConfig = function(e) {
            var t;
            return "string" != typeof (e = l(l({}, dn), "object" == typeof e && e ? e : {})).target && g.isElement(e.target) && ((t = p(e.target).attr("id")) || (t = g.getUID(ln),
        ...
        e._activate = function(t) {
            ...
            n.hasClass("dropdown-item") ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(pn),
            n.addClass(pn)) : (n.addClass(pn),
            n.parents(gn).prev(mn + ", " + vn).addClass(pn),
    ...
    var _n = "bs.tab"
      ...
      , Cn = function() {
        ...
        return e.show = function() {
            ...
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(xn) || p(this._element).hasClass("disabled") || (t = p(this._element).closest(".nav, .list-group")[0],
            n = g.getSelectorFromElement(this._element),
            t && (i = "UL" === t.nodeName || "OL" === t.nodeName ? Tn : En,
        ...
        e._activate = function(e, t, n) {
            ...
            var r, o = this, s = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? p(t).children(En) : p(t).find(Tn))[0], a = n && s && p(s).hasClass("fade");
        ...
        e._transitionComplete = function(e, t, n) {
            var i, r, o;
            t && (p(t).removeClass(xn),
            (i = p(t.parentNode).find("> .dropdown-menu .active")[0]) && p(i).removeClass(xn),
    ...
    p(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(e) {
        e.preventDefault(),
        Cn._jQueryInterface.call(p(this), "show")
    }),
    ...
    var Sn = "toast"
      ...
      , qn = function() {
        ...
        e.hide = function() {
            var e;
            this._element.classList.contains(jn) && (e = p.Event("hide.bs.toast"),
        ...
        e.dispose = function() {
            clearTimeout(this._timeout),
            this._timeout = null,
            this._element.classList.contains(jn) && this._element.classList.remove(jn),
        ...
        ,
        e._getConfig = function(e) {
            return e = l(l(l({}, In), p(this._element).data()), "object" == typeof e && e ? e : {}),
