...
!function(e, t) {
    ...
    var L = function(e) {
        ...
        r(t, [{
            ...
            value: function(e, t, n) {
                ...
                var s = m(this.data, a);
                return s || !r || "string" != typeof n ? s : function e(t, n) {
                    var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : ".";
                    if (t) {
                        if (t[n])
                            return t[n];
                        for (var o = n.split(i), r = t, a = 0; a < o.length; ++a) {
                            if ("string" == typeof r[o[a]] && a + 1 < o.length)
                                return;
                            if (void 0 === r[o[a]]) {
                                for (var s = 2, u = o.slice(a, a + s).join(i), l = r[u]; void 0 === l && o.length > a + s; )
                                    s++,
                                    l = r[u = o.slice(a, a + s).join(i)];
                                if (void 0 === l)
                                    return;
                                if ("string" == typeof l)
                                    return l;
                                if (u && "string" == typeof l[u])
                                    return l[u];
                                var c = o.slice(a + s).join(i);
                                return c ? e(l, c, i) : void 0
                            }
                            r = r[o[a]]
                        }
                        return r
            ...
            value: function(e, t, i, o, r) {
                ...
                o ? function e(t, n, i) {
                    for (var o in n)
                        "__proto__" !== o && "constructor" !== o && (o in t ? "string" == typeof t[o] || t[o]instanceof String || "string" == typeof n[o] || n[o]instanceof String ? i && (t[o] = n[o]) : e(t[o], n[o], i) : t[o] = n[o]);
                    return t
                }(u, i, r) : u = n({}, u, i),
                y(this.data, s, u),
        ...
        r(o, [{
            ...
            value: function(e, t) {
                ...
                if (n && e.indexOf(n) > -1) {
                    ...
                    var a = e.split(n);
                    (n !== i || n === i && this.options.ns.indexOf(a[0]) > -1) && (o = a.shift()),
                    e = a.join(i)
                }
            ...
            value: function(t, i, r) {
                ...
                var s = void 0 !== i.keySeparator ? i.keySeparator : this.options.keySeparator
                  , u = this.extractFromKey(t[t.length - 1], i)
                  , l = u.key
                  , c = u.namespaces
                  , p = c[c.length - 1]
                ...
                var d = this.resolve(t, i)
                  ...
                  , k = void 0 !== i.joinArrays ? i.joinArrays : this.options.joinArrays
                  , x = !this.i18nFormat || this.i18nFormat.handleAsObject;
                if (x && v && ("string" != typeof v && "boolean" != typeof v && "number" != typeof v) && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(b) < 0 && ("string" != typeof k || "[object Array]" !== b)) {
                    if (!i.returnObjects && !this.options.returnObjects)
                        ...
                        this.options.returnedObjectHandler ? this.options.returnedObjectHandler(y, v, n({}, i, {
                            ns: c
                    ...
                    if (s) {
                        ...
                        for (var O in v)
                            if (Object.prototype.hasOwnProperty.call(v, O)) {
                                var N = "".concat(L).concat(s).concat(O);
                                w[O] = this.translate(N, n({}, i, {
                                    joinArrays: !1,
                                    ns: c
                                })),
                                w[O] === N && (w[O] = v[O])
                    ...
                    (v = v.join(k)) && (v = this.extendTranslation(v, t, i, r));
                else {
                    var R = !1
                      , j = !1
                      , C = void 0 !== i.count && "string" != typeof i.count
                      , P = o.hasDefaultValue(i)
                      , E = C ? this.pluralResolver.getSuffix(g, i.count) : ""
                      , F = i["defaultValue".concat(E)] || i.defaultValue;
                    !this.isValidLookup(v) && P && (R = !0,
                    v = F),
                    this.isValidLookup(v) || (j = !0,
                    v = l);
                    var V = (i.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && j ? void 0 : v
                      , T = P && F !== v && this.options.updateMissing;
                    if (j || R || T) {
                        if (this.logger.log(T ? "updateKey" : "missingKey", g, p, l, T ? F : v),
                        s) {
                        ...
                        if ("fallback" === this.options.saveMissingTo && D && D[0])
                            ...
                            "all" === this.options.saveMissingTo ? U = this.languageUtils.toResolveHierarchy(i.lng || this.language) : U.push(i.lng || this.language);
                        var K = function(e, t, n) {
                            a.options.missingKeyHandler ? a.options.missingKeyHandler(e, p, t, T ? n : V, T, i) : a.backendConnector && a.backendConnector.saveMissing && a.backendConnector.saveMissing(e, p, t, T ? n : V, T, i),
                            a.emit("missingKey", e, p, t, v)
                        };
                        this.options.saveMissing && (this.options.saveMissingPlurals && C ? U.forEach(function(e) {
                            a.pluralResolver.getSuffixes(e).forEach(function(t) {
                                K([e], l + t, i["defaultValue".concat(t)] || F)
                            })
                        }) : K(U, l, F))
                    }
                    v = this.extendTranslation(v, t, i, d, r),
                    j && v === l && this.options.appendNamespaceToMissingKey && (v = "".concat(p, ":").concat(l)),
                    (j || R) && this.options.parseMissingKeyHandler && (v = this.options.parseMissingKeyHandler(v))
                }
                return v
            }
        }, {
            ...
            value: function(e, t, i, o, r) {
                ...
                if (this.i18nFormat && this.i18nFormat.parse)
                    ...
                    var s, u = i.interpolation && i.interpolation.skipOnVariables || this.options.interpolation.skipOnVariables;
                    if (u) {
                        var l = e.match(this.interpolator.nestingRegexp);
                        s = l && l.length
                    }
                    var c = i.replace && "string" != typeof i.replace ? i.replace : i;
                    if (this.options.interpolation.defaultVariables && (c = n({}, this.options.interpolation.defaultVariables, c)),
                    e = this.interpolator.interpolate(e, c, i.lng || this.language, i),
                    u) {
                    ...
                    !1 !== i.nest && (e = this.interpolator.nest(e, function() {
                        for (var e = arguments.length, n = new Array(e), o = 0; o < e; o++)
                            n[o] = arguments[o];
                        return r && r[0] === n[0] && !i.context ? (a.logger.warn("It seems you are nesting recursively key: ".concat(n[0], " in key: ").concat(t[0])),
                        null) : a.translate.apply(a, n.concat([t]))
                    }, i)),
                    i.interpolation && this.interpolator.reset()
                }
                var g = i.postProcess || this.options.postProcess
                  , f = "string" == typeof g ? [g] : g;
                return null != e && f && f.length && !1 !== i.applyPostProcessor && (e = O.handle(f, e, t, this.options && this.options.postProcessPassResolved ? n({
                    i18nResolved: o
                }, i) : i, this)),
                e
            }
                ...
                e.forEach(function(e) {
                    if (!a.isValidLookup(t)) {
                        ...
                        c.forEach(function(e) {
                            a.isValidLookup(t) || (r = e,
                            !N["".concat(f[0], "-").concat(e)] && a.utils && a.utils.hasLoadedNamespace && !a.utils.hasLoadedNamespace(r) && (N["".concat(f[0], "-").concat(e)] = !0,
                            ...
                            f.forEach(function(n) {
                                if (!a.isValidLookup(t)) {
                                    ...
                                    if (a.i18nFormat && a.i18nFormat.addLookupKeys)
                                        ...
                                        p && g && f.push(c + r),
                                        g && f.push(c += "".concat(a.options.contextSeparator).concat(s.context)),
                                        p && f.push(c += r);
                                    for (; u = f.pop(); )
                                        a.isValidLookup(t) || (i = u,
            ...
            value: function(e) {
                for (var t in e)
                    if (Object.prototype.hasOwnProperty.call(e, t) && "defaultValue" === t.substring(0, "defaultValue".length) && void 0 !== e[t])
                        return !0;
                return !1
            }
        }]),
        ...
        return r(e, [{
            ...
            value: function(e, t) {
                ...
                if (i) {
                    ...
                    return "v1" === this.options.compatibilityJSON ? 1 === r ? "" : "number" == typeof r ? "_plural_".concat(r.toString()) : a() : "v2" === this.options.compatibilityJSON ? a() : this.options.simplifyPluralSuffix && 2 === i.numbers.length && 1 === i.numbers[0] ? a() : this.options.prepend && o.toString() ? this.options.prepend + o.toString() : o.toString()
                }
      ...
      , V = function() {
        ...
        return r(e, [{
            ...
            value: function(e, t, i, o) {
                var r, a, s, u = this, l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {};
                function c(e) {
                    return e.replace(/\$/g, "$$$$")
                }
                var p = function(e) {
                    if (e.indexOf(u.formatSeparator) < 0) {
                        var r = b(t, l, e);
                        return u.alwaysFormat ? u.format(r, void 0, i, n({}, o, t, {
                            interpolationkey: e
                        })) : r
                    }
                    ...
                    return u.format(b(t, l, s), c, i, n({}, o, t, {
                        interpolationkey: s
                    }))
                };
                this.resetRegExp();
                    ...
                    for (s = 0; r = t.regex.exec(e); ) {
                        if (void 0 === (a = p(r[1].trim())))
                            if ("function" == typeof g) {
                                ...
                                u.logger.warn("missed to pass in variable ".concat(r[1], " for interpolating ").concat(e)),
                                a = ""
                            }
                        else
                            "string" == typeof a || u.useRawValueToEscape || (a = d(a));
                        var i = t.safeValue(a);
                        if (e = e.replace(r[0], i),
            ...
            key: "nest",
            value: function(e, t) {
                var i, o, r = this, a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, s = n({}, a);
                function u(e, t) {
                ...
                delete s.defaultValue; i = this.nestingRegexp.exec(e); ) {
                    var l = []
                      , c = !1;
                    ...
                    if ((o = t(u.call(this, i[1].trim(), s), s)) && i[0] === e && "string" != typeof o)
                        return o;
                    "string" != typeof o && (o = d(o)),
                    o || (this.logger.warn("missed to resolve ".concat(i[1], " for nesting ").concat(e)),
                    o = ""),
                    c && (o = l.reduce(function(e, t) {
                        return r.format(e, t, a.lng, n({}, a, {
    ...
    var T = function(e) {
        function t(e, n, o) {
            ...
            r.state = {},
            r.queue = [],
            r.backend && r.backend.init && r.backend.init(o, l.backend, l),
            r
        }
        return c(t, f),
        r(t, [{
        ...
        r(o, [{
            ...
            value: function(e, t) {
                ...
                var o = function(o) {
                    ...
                    var r = "string" == typeof o ? o : n.services.languageUtils.getBestMatchFromCodes(o);
            ...
            value: function(t, i, o) {
                var r = this
                  , a = function t(i, a) {
                    var s;
                    if ("object" !== e(a)) {
                        for (var u = arguments.length, l = new Array(u > 2 ? u - 2 : 0), c = 2; c < u; c++)
                            l[c - 2] = arguments[c];
                        s = r.options.overloadTranslationOptionHandler([i, a].concat(l))
                    } else
                        s = n({}, a);
                    s.lng = s.lng || t.lng,
                    s.lngs = s.lngs || t.lngs,
                    s.ns = s.ns || t.ns;
                    var p = r.options.keySeparator || "."
                      , g = o ? "".concat(o).concat(p).concat(i) : i;
                    return r.t(g, s)
                };
                return "string" == typeof t ? a.lng = t : a.lngs = t,
                a.ns = i,
                a.keyPrefix = o,
                a
            }
